...
// const op = name5.flat(3)// this will return a single array : flat(infinity)-> when we dost want to mentions depth
// console.log(op)
...
// }
// const {coursestructure:name}=course // thi is nothing but de-structure {coursestructure:name}
// console.log(name);
...
// document.getElementById('title').setAtttribute('class','test')   -> it will the the class name of the title element
...
//  document.querySelector('h1') --> return the first element of h1 which present in out document
...
// const myul = document.querySelectorAll('li')// it will return nodelis all the li elements
...
// cont templist= document.getElementsByClassName(list-item)/ will convert this y using Array.from()
...
<script>
  ...
  console.log(dayone.nextElementSibling);// it will return the sibling ike here (monday sibling is tuesday)
